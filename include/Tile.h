...
public:
    ...
    void setCaps(int val)
    {
        caps = val;
    }

    bool containsElevator()
    {
        return elevator;
    }
    void makeElevator()
    ...
    bool isMinesweeperNumber()
    {
        return minesweeperNumber;
    }
    ...
    void setWall(string dir, bool val = true)
    {
        walls[dir] = val;
    }
    bool checkWall(string dir)
    {
        return walls[dir];
    }
