...
void Merchant::itemMenu()
{
    ...
    {
        cout << setw(25) << item.itemName << " for " << item.itemValue  << " caps?\t\t" << item.itemName[0] << endl;
    }
                    ...
                    if (choice == 'y')
                    {
                        if (store.contains(temp))
                        {
                            if(play.inventory.getCaps() >= temp.itemValue)
                            {
                                ...
                                cout << "I'm sorry, looks like you don't have enough caps for that.\n";
                        }
                        else
                            cout << "Sorry " << play.getName() << "This item is no longer available!\t\n";
                        end = 0;
                    }
                    else
                        cout << "This is discarded...\n";
                }
                else
                    cout << "That made no sense, please answer with valid input!\n";
            ...
            while (!flag)
            {
                ...
                if (choice == 'y' || choice == 'n')
                {
                    ...
                    else
                    {
                        ...
                        cout << "Wow big trip eh?\n";
                    }
                }
                else
                    cout << "What? I did not understand...\n";
                system(clsCommand.c_str());
            }
