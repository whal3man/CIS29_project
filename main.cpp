...
int main()
{
    ...
    while(input != "quit") {
        ...
        if((input == "up" || input == "north") && !currentTile.checkWall("up"))
        {
            pchar.moveUp();
        }
        else if((input == "down" || input == "south") && !currentTile.checkWall("down"))
        {
            pchar.moveDown();
        }
        else if((input == "left" || input == "west") && !currentTile.checkWall("left"))
        {
            pchar.moveLeft();
        }
        else if((input == "right" || input == "east") && !currentTile.checkWall("right"))
        {
            pchar.moveRight();
        }
